  ...
  return (
    <aside className="text-white p-4 pr-0">
      <Link href="/" className="flex gap-2 mb-4 mr-4">
        ...
        <span className="">Bogo Admin</span>
      </Link>
      <nav className="flex flex-col gap-2">
        ...
        <Link href="/products" className={handleActiveLink('/products')}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <Link href="/orders" className={handleActiveLink('/orders')}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <Link href="/settings" className={handleActiveLink('/settings')}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
